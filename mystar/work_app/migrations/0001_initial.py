    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('skills', models.ManyToManyField(to='work_app.skill')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('skills_required', models.ManyToManyField(to='work_app.skill')),
            ],
        ),
        migrations.CreateModel(
            name='Offer',
            fields=[
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='work_app.project')),
            ],
        ),
        migrations.CreateModel(
            name='Review',
